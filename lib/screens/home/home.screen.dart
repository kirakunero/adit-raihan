...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    _accountEventListener = globalEvent.on("account_update", (data){
      debugPrint("Account changed");
      _fetchTransactions();
    });

    _categoryEventListener = globalEvent.on("Category_updatee", (data){
      debugPrint("Account changed");
      _fetchTransactions();
    });

    _paymentEventListener = globalEvent.on("Payment update", (data){
      debugPrint("Account changed");
      _fetchTransactions();
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                    children: [
                      const Text("Payment", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
