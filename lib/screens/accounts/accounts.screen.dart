                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text.rich(
                              TextSpan(
                                  children: [
                                    TextSpan(text:"Balance", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
                                  ]
                              )
                          ),
                                ...
                                onTap: (){
                                  WidgetsBinding.instance.addPostFrameCallback((_) {
                                    ConfirmModal.showConfirmDialog(
                                        context,
                                        title: "Are you sure?",
                                        content: const Text("All payments to be cleared belong to this account"),
                                        onConfirm: () async {
